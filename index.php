...
<body>
      ...
      <div class="container">
        ...
        <div class="portfolio__tabs-wrapper">
          <div class="portfolio__tabs">
            <!-- Табы загружаются динамически из API -->
          </div>
        </div>
          ...
          <div class="contact__content fade-in">
            ...
            <div class="contact__socials-wrapper">
              ...
              <div class="contact__socials">
                ...
                <a href="https://t.me/Anna_Pakseleva" target="_blank" class="contact__social" aria-label="Telegram" data-analytics="telegram">
            ...
            <form id="mainForm" action="api/send.php" method="POST">
              ...
              <div class="form__group">
                <label class="form__checkbox">
                  ...
                  <span>Я согласен(а) с <a href="privacy.php" target="_blank" style="color: var(--color-primary); text-decoration: underline;">политикой конфиденциальности</a></span>
                </label>
              </div>
    ...
    <div class="modal__content">
      ...
      <div class="modal__body">
        ...
        <form id="modalForm" action="api/send.php" method="POST">
          ...
          <div class="form__group">
            <label class="form__checkbox">
              <input type="checkbox" name="privacy_agree" id="modal_privacy_agree" required checked>
              <span>Я согласен(а) с <a href="privacy.php" target="_blank" style="color: var(--color-primary); text-decoration: underline;">политикой конфиденциальности</a></span>
            </label>
          </div>
  ...
  <div class="float-contact">
    <div class="float-contact__menu">
      ...
      <a href="https://t.me/Anna_Pakseleva" target="_blank" class="float-contact__item float-contact__item--telegram" title="Telegram">
...
<script type="text/javascript">
    ...
    })(window, document,'script','https://mc.yandex.ru/metrika/tag.js?id=105649895', 'ym');

    ym(105649895, 'init', {ssr:true, webvisor:true, clickmap:true, ecommerce:"dataLayer", accurateTrackBounce:true, trackLinks:true});
</script>
<noscript><div><img src="https://mc.yandex.ru/watch/105649895" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
</body>
</html>
