...
- **Mobile** — <768px (медиа-запросы в основном CSS)
...
Определение устройства происходит автоматически при загрузке страницы и при изменении размера окна. Файлы загружаются динамически только для планшетов, что оптимизирует загрузку для других устройств.
