...
- **Маска телефона** — +7 (___) ___-__-__
  - Если вбиваю `+` → добавляется только `+`
  - Если вбиваю `7` → добавляется `+7`
  - Если вбиваю `8` → заменяется на `+7`
  - Если вбиваю остальные цифры → добавляется `+7` и потом цифра (например, ввод "9" → "+7 (9...")
  - Защита от удаления префикса +7 или +
  - Корректное позиционирование курсора при вводе и удалении
  - Поддержка вставки (paste) номеров
...
- ✅ Meta description (оптимизированная, до 150 символов)
- ✅ Alt-теги у всех изображений (описательные, с ключевыми словами)
- ✅ Семантическая разметка HTML5

### Расширенные meta-теги
- ✅ Title (оптимизированный, до 60 символов)
- ✅ Meta keywords (релевантные ключевые слова)
- ✅ Meta author
- ✅ Meta robots (index, follow)
- ✅ Geo-теги (геолокация для Калининграда)
- ✅ Canonical URL
...
- ✅ LocalBusiness — информация о студии
...
- ✅ Ссылка на sitemap в head и robots.txt

### Оптимизация изображений
- ✅ Описательные alt-теги с ключевыми словами
- ✅ Атрибуты width и height для основных изображений
- ✅ Lazy loading для изображений портфолио
- ✅ WebP формат для оптимизации размера

### Дополнительные улучшения
- ✅ Языковая разметка (lang="ru")
...
**Важно:** После размещения сайта на реальном домене необходимо:

1. **Заменить домен в файлах:**
   - `index.php` — все упоминания `https://annapakseleva.ru/` на ваш реальный домен
   - `sitemap.xml` — заменить `https://annapakseleva.ru/` на ваш домен
   - `robots.txt` — заменить `https://annapakseleva.ru/` на ваш домен

2. **Добавить сайт в поисковые системы:**
   - Яндекс.Вебмастер: https://webmaster.yandex.ru/
   - Google Search Console: https://search.google.com/search-console
   - Загрузить sitemap.xml в обе системы

3. **Проверить структурированные данные:**
   - Google Rich Results Test: https://search.google.com/test/rich-results
   - Яндекс.Валидатор разметки: https://validator.yandex.ru/markup/

4. **Оптимизировать изображения:**
   - Убедиться, что все изображения оптимизированы (WebP формат)
   - Проверить размеры изображений (рекомендуется до 200KB)
